                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-4 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
								...
								<div class="card-footer d-flex align-items-center justify-content-between">
									<a class="small stretched-link" href="loan_user.php">View Loan List</a>
									<div class="small">
                        ...
                        <div class="col-xl-4 col-md-4 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h1 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                $retrieve_query = mysqli_query($connections, "SELECT * FROM loan_application WHERE name = '$name' ");

                                              while($row = mysqli_fetch_assoc($retrieve_query)) {

                                                    $refno = $row['refno'];
                                                    $retrieve_query = mysqli_query($connections, "SELECT * FROM disbursement_tbl WHERE name = '$name' AND refno = '$refno' ");
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small stretched-link" href="payment_user.php">View Account Balance</a>
                                    <div class="small">
                                        <i class="fa fa-angle-right"></i>
                                    </div>
                                </div>
